...
const headFrag = [
  ...
  seo.googleSiteVerification
    ? tag("meta", { name: "google-site-verification", content: seo.googleSiteVerification })
    : "",
  seo.bingSiteVerification
    ? tag("meta", { name: "msvalidate.01", content: seo.bingSiteVerification })
    : "",
  seo.yandexSiteVerification
    ? tag("meta", { name: "yandex-verification", content: seo.yandexSiteVerification })
    : "",
  rssUrl
    ? tag("link", {
        rel: "alternate",

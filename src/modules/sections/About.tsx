    ...
    <div className="relative">
      ...
      <style>{`
        ...
        .about .typography h3 {
          ...
          color: color-mix(in oklch, var(--text) 80%, var(--accent));
          font-family: "JetBrains Mono", "Space Grotesk", "IBM Plex Mono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;
        }
        ...
        .about .typography code {
          ...
          padding: .15rem .35rem;
          border-radius: .4rem;
          font-family: "JetBrains Mono", "Fira Code", "Space Mono", ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;
